...
* An HC-SR04 ultrasonic range sensor mounted on top of a small hobby servo
...
// If we encounter an obstacle, back up and continue hiding
...

{
    ...
    /* function that helps the beta bot avoid capture */
    ...
    /* end of beta bot evasion function */
